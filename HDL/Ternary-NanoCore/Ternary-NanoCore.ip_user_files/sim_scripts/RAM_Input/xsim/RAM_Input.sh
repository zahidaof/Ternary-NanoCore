...
#
# Script generated by Vivado on Sat Dec 20 16:56:48 +0300 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : RAM_Input.sh
...
#
# Usage        : RAM_Input.sh
#                RAM_Input.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RAM_Input.sh [-reset_run]
#                RAM_Input.sh [-reset_log]
#                RAM_Input.sh [-help]
#
...
# script info
echo -e "RAM_Input.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RAM_Input.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RAM_Input xil_defaultlib.RAM_Input xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim RAM_Input -key {Behavioral:sim_1:Functional:RAM_Input} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb RAM_Input.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./RAM_Input.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: RAM_Input.sh [-help]\n\
Usage: RAM_Input.sh [-step]\n\
Usage: RAM_Input.sh [-lib_map_path]\n\
Usage: RAM_Input.sh [-reset_run]\n\
Usage: RAM_Input.sh [-reset_log]\n\
Usage: RAM_Input.sh [-keep_index]\n\
Usage: RAM_Input.sh [-noclean_files]\n\n\
