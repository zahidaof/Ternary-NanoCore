...
#
# Script generated by Vivado on Fri Nov 28 23:11:53 +0300 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ROM_Weights.sh
...
#
# Usage        : ROM_Weights.sh
#                ROM_Weights.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ROM_Weights.sh [-reset_run]
#                ROM_Weights.sh [-reset_log]
#                ROM_Weights.sh [-help]
#
...
# script info
echo -e "ROM_Weights.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ROM_Weights.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ROM_Weights xil_defaultlib.ROM_Weights xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ROM_Weights -key {Behavioral:sim_1:Functional:ROM_Weights} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ROM_Weights.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ROM_Weights.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ROM_Weights.sh [-help]\n\
Usage: ROM_Weights.sh [-step]\n\
Usage: ROM_Weights.sh [-lib_map_path]\n\
Usage: ROM_Weights.sh [-reset_run]\n\
Usage: ROM_Weights.sh [-reset_log]\n\
Usage: ROM_Weights.sh [-keep_index]\n\
Usage: ROM_Weights.sh [-noclean_files]\n\n\
