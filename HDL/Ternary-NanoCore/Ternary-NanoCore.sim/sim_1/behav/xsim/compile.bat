...
REM
REM Generated by Vivado on Sat Dec 20 16:37:11 +0300 2025
...
echo "xvlog --incr --relax -prj tb_ternary_nanocore_vlog.prj"
call xvlog  --incr --relax -prj tb_ternary_nanocore_vlog.prj -log xvlog.log
