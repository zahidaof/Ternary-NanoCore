...
HD_PWD='C:/Users/zahid/Desktop/Projects/Ternary/Ternary-NanoCore/Ternary-NanoCore/HDL/Ternary-NanoCore/Ternary-NanoCore.runs/RAM_Input_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_Input.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RAM_Input.tcl
