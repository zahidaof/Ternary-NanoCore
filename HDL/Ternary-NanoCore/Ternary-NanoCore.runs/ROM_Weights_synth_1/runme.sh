...
HD_PWD='C:/Users/zahid/Desktop/Projects/Ternary/Ternary-NanoCore/Ternary-NanoCore/HDL/Ternary-NanoCore/Ternary-NanoCore.runs/ROM_Weights_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROM_Weights.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROM_Weights.tcl
