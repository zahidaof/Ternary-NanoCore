...
HD_PWD='C:/Users/zahid/Desktop/Projects/Ternary/Ternary-NanoCore/Ternary-NanoCore/HDL/Ternary-NanoCore/Ternary-NanoCore.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ternary_nanocore_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ternary_nanocore_top.tcl
